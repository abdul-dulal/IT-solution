              ...
              return (
                <div key={blog.id}>
                  <div class=" relative mb-8   ">
                    <div class=" group mb-[18px] w-full  overflow-hidden">
                      <div class="relative  ">
                        <Image
                          src={blog.img}
                          width={360}
                          height={360}
                          alt="Description"
                          class="w-full h-[350px] transition-all duration-300 ease-in-out group-hover:scale-[1.1] group-hover:rotate-[1.2deg] group-hover:transition-all group-hover:duration-300 group-hover:ease-in-out"
                        />

                        <div class="absolute inset-0 bg-[rgba(8,24,69,0.7)] transition-all duration-300 ease-in-out h-[350px] "></div>
                      </div>
                      <Link
                        class=" w-[60px] h-[60px] flex items-center justify-center rounded-[50%] text-white leading-[65px] text-center  bg-[rgba(255,255,255,0.5)] absolute left-0 right-0 bottom-[40%] m-auto z-[3] transition-all duration-300 ease-in-out hover:bg-primary hover:text-white"
                        href={`/blog/${blog.title}`}
                      >
                        <FaArrowRight />
                      </Link>
                      <div class="biMeta2 absolute left-0 right-0 m-auto bottom-[25%] z-[3] flex justify-center">
                        <Link
                          href={`/blog/${blog.title}`}
