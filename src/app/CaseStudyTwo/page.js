                ...
                >
                  ...
                  >
                    <div class="fs-content absolute left-0 top-[50%] -translate-y-[50%] w-full text-center pb-[15px] z-[2]">
                      ...
                      <p class="cats text-[rgba(255,255,255,0.8)] m-0 translate-y-[30px] opacity-0 invisible transition-all ease-in-out duration-1000 hover:text-[#191919] group-hover:translate-y-0 group-hover:visible group-hover:opacity-100">
                        <Link href={`/folioCat/${item.tech}`}>{item.tech}</Link>
                      </p>
                    </div>
                  </div>
                </div>
