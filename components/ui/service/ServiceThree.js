...
const Services = ({ title, icon }) => {
  return (
    <div class="group">
      <div class="service-item-04 relative mb-[30px] border-[5px] border-solid border-transparent rounded-[10px] py-10 px-7   text-center transition-all duration-400 ease-in-out hover:border-primary">
        <div class="ib-icon text-[70px] leading-[70px]  inline-block text-center mb-[27px] transition-all duration-400 ease-in-out">
          <svg
