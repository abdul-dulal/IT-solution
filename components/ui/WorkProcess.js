...
const WorkProcess = ({ title, serial, icon }) => {
  return (
    <div class=" group relative mt-10 bg-[#081845] hover:bg-primary rounded-[10px] pt-8 px-5 pb-[50px] transition-all duration-300 ease-in text-center">
      ...
      <div class=" text-xl text-primary leading-[120px] -mt-6 mb-[53px] inline-block m-auto">
